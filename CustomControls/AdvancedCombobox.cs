...
namespace _3S_eShop.CustomComponents
{
    ...
    public class AdvancedCombobox : UserControl
    {
        ...
        // Update the SelectedIndex property to handle cross-thread operations safely
        public int SelectedIndex
        {
            get
            {
                ...
                {
                    return (int)cmbList.Invoke(new Func<int>(() => cmbList.SelectedIndex));
                }
                else
                {
            ...
            set
            {
                if (cmbList.InvokeRequired)
                {
                    cmbList.Invoke(new Action(() => cmbList.SelectedIndex = value));
                }
                else
                {
